...
#taichung = gp.read_file("C:\\final_project\\COUNTYID_B.geojson")
taichungmap_1x1 = gp.read_file("/home/hpc/taichung1x1.geojson")
...
fmap.save('/var/www/html/mix2') #存成 final.html
