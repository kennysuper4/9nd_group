...
df = pd.DataFrame(js)
predict1 = df.iloc[96:112]
predict1['Longitude']=[120.498566,120.697299,120.741711,120.616917,
...
predict1['Latitude']=[24.201030,24.057350,24.256586,24.162200,
...
taichungmap_1x1 = gp.read_file("/home/hpc/1taichung1x1.geojson")         #台中1*1網格
...
fmap.save('/var/www/html/predict1')#存成 final.html